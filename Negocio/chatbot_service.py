...
class ChatbotService:
    @staticmethod
    def consultar_chatbot_logico(mensaje):
        """
        PARADIGMA LÓGICO: Motor de Inferencia pyDatalog
        """
        pyDatalog.clear()

        # Cargamos los hechos desde la BD
        ...
        if resultados_objetos:
            ...
            return "Aquí tienes las opciones que deduje para ti:<br><ul style='margin: 5px 0; padding-left: 20px;'>" + "".join(lista_html) + "</ul>"
